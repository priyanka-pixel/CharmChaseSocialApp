            ...
            if (messageType == CometChatConstants.MESSAGE_TYPE_TEXT) {
                ...
                try {
                    ...
                    for (i in 0 until options.length()) {
                        ...
                        textViewOption.setTextAppearance(this, R.style.TextAppearance_AppCompat_Medium_1)
                        textViewPercentage.setTextAppearance(this, R.style.TextAppearance_AppCompat_Medium_1)
