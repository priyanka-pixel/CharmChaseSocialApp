        ...
        if (messageType == CometChatConstants.MESSAGE_TYPE_IMAGE) {
            ...
            try {
                ...
                for (k in 0 until options.length()) {
                    ...
                    textViewOption.setTextAppearance(context, R.style.TextAppearance_AppCompat_Medium_1)
                    textViewPercentage.setTextAppearance(context, R.style.TextAppearance_AppCompat_Medium_1)
